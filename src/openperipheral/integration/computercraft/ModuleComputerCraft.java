...
public class ModuleComputerCraft implements IIntegrationModule {
	...
	private void addPrintoutInfo(Map<String, Object> map, ItemStack stack, Item item) {
		HashMap<String, Object> printoutMap = Maps.newHashMap();
	...
	private void addComputerInfo(Map<String, Object> map, ItemStack stack, Item item) {
		HashMap<String, Object> computerInfo = Maps.newHashMap();
	...
	private void addSideInfo(Map<String, Object> map, String side, ITurtleUpgrade upgrade) {
		if(upgrade != null){
			HashMap<Object, Object> upgradeMap = Maps.newHashMap();

...
public class ModInfo {
	...
	public static final String DEPENDENCIES = "required-after:OpenMods@[0.4,];required-after:ComputerCraft@[1.6,];after:AppliedEnergistics;after:IC2;after:EnderStorage;after:BuildCraft|Core;after:Forestry;after:Mystcraft;after:ProjRed|Transmission;after:Railcraft;after:Thaumcraft;after:ThermalExpansion;after:SGCraft;";
}

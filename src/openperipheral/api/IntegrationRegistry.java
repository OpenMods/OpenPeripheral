...
public class IntegrationRegistry {
	...
	public boolean registerAdapter(IPeripheralAdapter adapter) {
		return register(
				IPeripheralAdapter.class,
				adapter,
				"openperipheral.core.AdapterManager",
				"addPeripheralAdapter"
			);
	}
	...
	public boolean registerTypeConverter(ITypeConverter converter) {
		return register(
				...
				converter,
				"openperipheral.core.TypeConversionRegistry",
	...
	public boolean registerRobotUpgradeProvider(IRobotUpgradeProvider provider) {
		return register(
			IRobotUpgradeProvider.class,
			provider,
			"openperipheral.robot.RobotUpgradeManager",
			"registerUpgradeProvider"
		);
	}

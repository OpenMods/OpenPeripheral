...
public class PacketChunker {
	...
	/***
	 * Get the bytes from the packet. If the total packet is not yet complete (and we're waiting for more to complete the sequence),
	 * We return null. Otherwise we return the full byte array
	 * @param one of the packets

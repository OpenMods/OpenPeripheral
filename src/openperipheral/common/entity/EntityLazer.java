...
public class EntityLazer extends Entity implements IThrowableEntity {
	...
	public EntityLazer(World world, EntityRobot robot) {
		...
		this.accelerationX = velocity.x;
		this.accelerationY = velocity.y;
		this.accelerationZ = velocity.z;
	}
	...
	public void onUpdate() {
		if (!this.worldObj.isRemote
			...
			if (this.isInWater()) {
				for (int k = 0; k < 4; ++k) {
					float f3 = 0.25F;
					this.worldObj.spawnParticle("bubble", this.posX - this.motionX * (double) f3, this.posY - this.motionY * (double) f3, this.posZ - this.motionZ
							* (double) f3, this.motionX, this.motionY, this.motionZ);
				}

...
public abstract class Transformation {
	...
	/**
	 * Applies this transformation to a matrix as a multiplication on the right
	 * hand side.
	 * 
	 * @param mat
	...
	/**
	 * @param point
	 *            The point in OBJECT space to apply this transformation around
	 * @return Wraps this transformation in a translation to point and then back
	 *         from point
	 */
	...
	/**
	 * Creates a transformation list composed of this transformation followed by
	 * t
	 * If this is a TransformationList, the transformation will be appended and
	 * this returned
	 */
